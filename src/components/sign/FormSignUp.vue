<template>
  <div class="input-box">
    ...
    <form
      @submit="signUpSubmit"
      class="input-box-signUp needs-validation">
      <div>
        <label for="nameSignUp">이름</label>
        <input
          type="text"
          v-model="signUpData.nameSignUp"
          id="nameSignUp"
          class="form-control"
          required />
      ...
      <div>
        ...
        <div class="input-inside">
          <input
            type="text"
            v-model="signUpData.emailSignUp"
            id="emailSignUp"
            class="form-control"
            required />
      ...
      <div>
        ...
        <input
          type="number"
          v-model="signUpData.contactSignUp"
          id="contactSignUp"
          class="form-control"
          required />
        <div class="invalid-feedback">
      ...
      <div class="btn-sign-up">
        <BasicButton
          :class="{primary : true, lg: true, mn:true}"
          type="submit"
